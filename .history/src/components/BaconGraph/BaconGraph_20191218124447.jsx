...
const BaconGraph = ({ classes, levelCount, links, nodesGrouped, onGotNodeRef }) => {
...
const enhance = compose(
  ...
  withHandlers({
    onGotNodeRef: ({ nodesGrouped }) => (nodeId, nodeRef) => {
      setRef(nodeId, nodeRef);
      console.log('got ref', flatten(nodesGrouped).length, Object.keys(getRefs()).length);
    },
  }),
  injectSheet(styles),
);
