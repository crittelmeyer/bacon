...
const BaconNode = ({ classes, hover, node, onClick, onKeyUp, onMouseEnter, onMouseLeave, rootRef, tabIndex }) => (
  <div
    ...
    tabIndex={tabIndex}
  >
    <div className={classNames(classes.content, { [classes.contentHover]: hover })}>
      <div
