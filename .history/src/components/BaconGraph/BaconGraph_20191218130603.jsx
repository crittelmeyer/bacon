  ...
  <div className={classes.root}>
    ...
    {nodesReady && (
      <svg width="500" height="500">
        {map(line => {
          console.log(line, nodeRefs);
          return <line x1="50" y1="50" x2="350" y2="350" stroke="black" />;
        }, lines)}
        {map.convert({ cap: false })((nodeRef, key) => {
          const rect = nodeRef.getBoundingClientRect();

          console.log('got it', key, rect);
          return <line key={key} x1={rect.x} y1={rect.y} x2="350" y2="350" stroke="black" />;
        }, nodeRefs)}
      </svg>)}
  </div>
);
