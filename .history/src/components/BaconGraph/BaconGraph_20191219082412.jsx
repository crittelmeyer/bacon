...
const BaconGraph = ({ classes, levelCount, links, nodeRefs, nodesGrouped, nodesReady, onGotNodeRef, onNodeClick, onNodeKeyUp, openDrawer }) => (
  <div className={classes.root}>
    <Drawer anchor="right" open={!isEmpty(openDrawer)}>
